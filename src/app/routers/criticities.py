...
router = APIRouter(prefix="/criticities", tags=["Criticidades"])


@router.get("", summary="Consulta todas las criticidades")
def get_criticities():
...
@router.get("/{id}", summary="Consulta una criticidad específica")
...
@router.delete("/{id}", summary="Elimina una criticidad de la base de datos")
...
@router.patch("/{id}", summary="Actualiza el nombre de una criticidad")
